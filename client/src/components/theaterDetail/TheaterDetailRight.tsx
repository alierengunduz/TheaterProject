...
const TheaterDetailRight = () => {
  const { theaterDetail, status, error } = useSelector(
  ...
  const formattedTime = theaterDetail?.time
    ? new Date(theaterDetail.time).toLocaleTimeString()
    : "";
...
export default TheaterDetailRight;
